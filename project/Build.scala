...
object Dependencies {
  ...
  val confluent = "io.confluent" % "kafka-avro-serializer" % "1.0.1"
  val kafkaClients = "org.apache.kafka" % "kafka-clients" % "0.8.2.0"
  val avroTools = "org.apache.avro" % "avro-tools" % "1.7.7"
  val jackson = "com.fasterxml.jackson.module" %% "jackson-module-scala" % "2.6.3"
  val jdbc = "mysql" % "mysql-connector-java" % "5.1.6"
  val connectionPool = "com.mchange" % "c3p0" % "0.9.5.1"
}
